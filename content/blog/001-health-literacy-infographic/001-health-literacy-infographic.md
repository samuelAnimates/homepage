...
![American Cancer Society infographic: Preventing Skin Cancer. The graphic is made up of 6 distinct sections, each with a different message.](./img01.png)
...
![An illustration of a stick figure, along with a list of 12 risk factors. The heading is "Anyone can get skin cancer. But be extra careful if you...](./img02.png)
...
![An edited version of the previous illustration. It lists 6 risk factors, pointing to relevant parts of the stick figure. The heading is now, "Who should be extra careful to protect their skin?"](./img03.png)
...
![Top section of the "Preventing Skin Cancer" infographic. It includes an intro paragraph and two graphics described in the article body](./img04.png)
...
![Infographic page. It reads: The sun's rays can cause DNA damage that leads to skin cancer and aging. Skin cancer is the most common type of cancer, but there is good news. You can take these steps to protect yourself and your family. Cover up and seek shade. Use sunscreen. Be extra careful with kids and babies.](./img05.png)
